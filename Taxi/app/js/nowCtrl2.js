    ...
    function fhvCar(){
        try {
            ...
            data: [{        
                ...
                legendText: "0- 23 hours",
                dataPoints: [      
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['0'], label: "0" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['1'],  label: "1" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['2'],  label: "2" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['3'],  label: "3" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['4'],  label: "4" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['5'], label: "5" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['6'],  label: "6" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['7'],  label: "7" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['8'], label: "8" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['9'],  label: "9" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['10'],  label: "10" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['11'],  label: "11" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['12'],  label: "12" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['13'], label: "13" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['14'],  label: "14" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['15'],  label: "15" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['16'], label: "16" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['17'],  label: "17" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['18'],  label: "18" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['19'],  label: "19" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['20'],  label: "20" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['21'], label: "21" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['22'],  label: "22" },
                    { y: that.liveData.fhv.agrupado2.DropOff_datetime['23'],  label: "23" }
                ]
            }]
        });
        chart.render();
